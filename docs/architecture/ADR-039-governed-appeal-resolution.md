...
7. A separate authorized human releases the notice. The `POST_DECISION_COMMUNICATION_DELIVERY_COMPLIANCE.md` transport can then queue/retry/reconcile delivery without gaining adjudication authority.
