...
class EnterpriseIndependentOutcomeAssuranceRequest(BaseModel):
    recovery_program_id: str
    release96_enterprise_recovery_execution_version_id: str
    release96_independent_effectiveness_assurance_version_id: str
    reviewer_role: str
...
class EnterpriseSustainabilityWindowRequest(BaseModel):
    ...
    minimum_window_days: int = 120
    minimum_control_health_score: float = 90.0
    observations: list[dict[str, Any]] = Field(default_factory=list)

class EnterpriseReclosureReadinessRequest(BaseModel):
    recovery_program_id: str
    release96_enterprise_execution_reference_present: bool = False
    release96_independent_assurance_reference_present: bool = False
...
class EnterpriseSustainabilityReclosureRequest(BaseModel):
    ...
    actor_role: str
    decision: str
    enterprise_recovery_recertification_version_id: str
