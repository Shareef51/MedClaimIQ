...
class EnterpriseRecoveryDecayRequest(BaseModel):
    ...
    release97_enterprise_sustainability_reclosure_version_id: str
    release97_reclosure_control_health_score: float = 100.0
...
class EnterpriseRiskReboundRequest(BaseModel):
    recovery_program_id: str
    release97_reclosure_systemic_risk_score: float
...
class EnterpriseReopeningReadinessRequest(BaseModel):
    release97_enterprise_sustainability_reclosure_reference_validated: bool = False
...
class EnterpriseSurveillanceDashboardRequest(BaseModel):
    ...
    release97_reclosure_control_health_score: float = 100.0
    current_control_health_score: float = 100.0
    release97_reclosure_systemic_risk_score: float = 0.0
