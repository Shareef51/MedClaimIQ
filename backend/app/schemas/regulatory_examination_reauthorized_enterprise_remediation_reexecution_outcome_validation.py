...
class EnterpriseRecoveryOutcomeRequest(BaseModel):
    ...
    release104_enterprise_remediation_reexecution_version_id: str
...
class EnterpriseSystemicRiskReductionRequest(BaseModel):
    recovery_program_id: str
    release104_baseline_systemic_risk_score: float
...
class EnterpriseIndependentOutcomeAssuranceRequest(BaseModel):
    recovery_program_id: str
    release104_enterprise_remediation_reexecution_version_id: str
    release104_independent_recovery_effectiveness_assurance_version_id: str
    reviewer_role: str
...
class EnterpriseReclosureReadinessRequest(BaseModel):
    recovery_program_id: str
    release104_enterprise_remediation_reexecution_reference_present: bool = False
    release104_independent_recovery_effectiveness_assurance_reference_present: bool = False
...
class EnterpriseSustainabilityReclosureRequest(BaseModel):
    ...
    actor_role: str
    decision: str
    reauthorized_enterprise_remediation_reexecution_systemic_recovery_recertification_version_id: str
