...
from app.domain.regulatory_examination_reclosed_reauthorized_enterprise_remediation_surveillance import reclosed_reauthorized_enterprise_remediation_surveillance_contract
from app.schemas.regulatory_examination_reclosed_reauthorized_enterprise_remediation_surveillance import *
from app.services.regulatory_examination_reclosed_reauthorized_enterprise_remediation_surveillance import RegulatoryExaminationReclosedReauthorizedEnterpriseRemediationSurveillanceService

router = APIRouter(tags=["regulatory-examination-reclosed-reauthorized-enterprise-remediation-surveillance"])
BASE = "/regulatory-examination-reclosed-reauthorized-enterprise-remediation-surveillance"
...
def _svc(db, identity):
    return RegulatoryExaminationReclosedReauthorizedEnterpriseRemediationSurveillanceService(db, identity.principal.tenant_id)
...
def model():
    return reclosed_reauthorized_enterprise_remediation_surveillance_contract()
