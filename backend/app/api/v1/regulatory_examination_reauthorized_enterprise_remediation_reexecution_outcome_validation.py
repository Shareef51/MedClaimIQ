...
from app.domain.regulatory_examination_reauthorized_enterprise_remediation_reexecution_outcome_validation import reauthorized_enterprise_remediation_reexecution_outcome_contract
from app.schemas.regulatory_examination_reauthorized_enterprise_remediation_reexecution_outcome_validation import *
...
router = APIRouter(prefix="/regulatory-examination-reauthorized-enterprise-remediation-reexecution-outcome-validation", tags=["regulatory-examination-reauthorized-enterprise-remediation-reexecution-outcome-validation"])

def svc(x_tenant_id: str = Header(default="default")):
    return RegulatoryExaminationReauthorizedEnterpriseRemediationReExecutionOutcomeValidationService(None, x_tenant_id)

@router.get("/model")
def model(): return reauthorized_enterprise_remediation_reexecution_outcome_contract()
