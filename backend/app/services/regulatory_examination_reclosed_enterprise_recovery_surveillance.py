...
class RegulatoryExaminationReclosedEnterpriseRecoverySurveillanceService:
    ...
    def _release97(self, payload: dict):
        if not payload.get("release97_enterprise_sustainability_reclosure_version_id"):
            raise ValueError("Release 97 enterprise sustainability reclosure version is required")

    def decay(self, payload: dict):
        self._release97(payload)
