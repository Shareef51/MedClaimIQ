...
def root_cause_treatment_decay(payload: dict) -> dict:
    ...
    for treatment in treatments:
        ...
        prior = str(treatment.get("release101_reclosure_status", treatment.get("prior_status", "effective"))).lower()
...
def multi_cycle_enterprise_recovery_decay(payload: dict) -> dict:
    baseline = float(payload.get("release101_reclosure_control_health_score", payload.get("reclosure_control_health_score", 100)) or 100)
...
def systemic_control_retransformation_regression(payload: dict) -> dict:
    ...
    for control in controls:
        ...
        prior = str(control.get("release101_reclosure_status", control.get("prior_status", ""))).lower()
...
def systemic_risk_rebound(payload: dict) -> dict:
    baseline = float(payload.get("release101_reclosure_systemic_risk_score", payload.get("reclosure_systemic_risk_score", 0)) or 0)
    ...
    return {
        "release101_reclosure_systemic_risk_score": baseline,
...
def prior_enterprise_reclosure_comparison(payload: dict) -> dict:
    ...
    return {
        "release101_systemic_recovery_recertification_version_id": prior.get("enterprise_recovery_recertification_version_id"),
        "release101_reauthorized_enterprise_remediation_sustainability_reclosure_version_id": prior.get("enterprise_sustainability_reclosure_version_id"),
...
def enterprise_reopening_readiness(payload: dict) -> dict:
    checks = {
        "release101_reauthorized_enterprise_remediation_sustainability_reclosure_reference_validated": bool(payload.get("release101_reauthorized_enterprise_remediation_sustainability_reclosure_reference_validated")),
...
def audit_export_manifest(payload: dict) -> dict:
    ...
    return {
        ...
        "recovery_program_id": payload.get("recovery_program_id"),
        "release101_reauthorized_enterprise_remediation_sustainability_reclosure_version_id": payload.get("release101_reauthorized_enterprise_remediation_sustainability_reclosure_version_id"),
        "evidence_refs": refs,
